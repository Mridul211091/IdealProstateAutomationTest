package agi.qa.idealprostate.utils;
...
import agi.qa.idealprostate.exceptions.ElementException;
...
public class ElementUtil {
	...
	public void ClearField(By locator, String value) throws InterruptedException {
		nullBlankCheck(value);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(TimeUtil.DEFAULT_MEDIUM_TIME));
		//WebElement element = wait.until(ExpectedConditions.elementToBeClickable(locator));
		Actions actions = new Actions(driver);
